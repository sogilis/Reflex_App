...
package body Rxunit.Test_Results is
   ...
   is
	...
	(Test_Name, Routine_Name,
	 Failure => null,
	 Error   => new Test_Error,
	 Elapsed => Elapsed);
      use Result_Lists;
   begin
      Val.Error.all := Error;
   ...
   function Test_Count (R : Result) return Ada.Containers.Count_Type is
   begin
      return R.Tests_Run;
   end Test_Count;
