Feature: Scenario Lower For Float 
  ...
  Scenario: Actual is strictly lower than expected 
    Given a file "features/data/tmp-lower-float.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-lower-float.feature
    Then it should pass
  ...
  Scenario: Actual equals expected 
    Given a file "features/data/tmp-lower-float1.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-lower-float1.feature
    Then it should pass
    When I run the test suite "./suite" in features/data/tests
    Then it should pass with
      """
  ...
  Scenario: Actual strictly smaller than expected 
    Given a file "features/data/tmp-lower-float2.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-lower-float2.feature
    Then it should pass
    When I run the test suite "./suite" in features/data/tests
    Then it should fail 
