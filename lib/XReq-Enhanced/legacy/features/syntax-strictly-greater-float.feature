Feature: Scenario Strictly Greater For Float 
  ...
  Scenario: Actual is strictly greater than expected 
    Given a file "features/data/tmp-strictly-greater-float.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-strictly-greater-float.feature
    Then it should pass
  ...
  Scenario: Actual equals expected 
    Given a file "features/data/tmp-strictly-greater-float1.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-strictly-greater-float1.feature
    Then it should pass
    When I run the test suite "./suite" in features/data/tests
    Then it should fail 

  Scenario: Actual strictly smaller than expected 
    Given a file "features/data/tmp-strictly-greater-float2.feature":
      """
      Feature: heating
      ...
      """
    When I run xreq -m -x suite features/data/tmp-strictly-greater-float2.feature
    Then it should pass
    When I run the test suite "./suite" in features/data/tests
    Then it should fail 
