...
package XReq.Steps.Handles is
   ...
   package Handles_Pkg is new Reffy.Handles (Step_Type, Step_Ptr);
   ...
   function Stanza_Given
     (S    : String;
      File : String  := "";
      Line : Natural := 0) return Step_Handle;
   function Stanza_When
     (S    : String;
      File : String  := "";
      Line : Natural := 0) return Step_Handle;
   function Stanza_Then
     (S    : String;
      File : String  := "";
      Line : Natural := 0) return Step_Handle;
