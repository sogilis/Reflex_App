...
package body XReq.Scenarios is
   ...
   function Step_First (Scenario : Scenario_Type) return Natural is
   ...
   function Step_Last (Scenario : Scenario_Type) return Integer is
      use Ada.Containers;
      use Step_Vectors;
   begin
   ...
   function Step_Count (Scenario : Scenario_Type) return Natural is
      use Ada.Containers;
      use Step_Vectors;
   begin
   ...
   function Tag_First (Scenario : Scenario_Type) return Natural is
      pragma Unreferenced (Scenario);
   begin
      return 0;
   end Tag_First;
   ...
   function Tag_Last (Scenario : Scenario_Type) return Integer is
   begin
   ...
   function Tag_Count (Scenario : Scenario_Type) return Natural is
      use Ada.Containers;
      use String_Vectors;
   begin
   ...
   function Outline (S : Scenario_Type) return Boolean is
   begin
      return S.D.Outline;
   end Outline;
   ...
   function Position (S : Scenario_Type) return Position_Type is
   begin
      return S.D.Pos;
   end Position;
   ...
   function Tag_Vector (S : Scenario_Type) return String_Vector is
   begin
      return S.D.Tags;
   end Tag_Vector;
   ...
   function Table (S : Scenario_Type) return XReqLib.String_Tables.Table is
   begin
      return S.D.Table;
   end Table;
   ...
   procedure Set_Name (S : in out Scenario_Type; Name : String) is
   begin
   ...
   function Equals (Left, Right : Scenario_Type) return Boolean is
