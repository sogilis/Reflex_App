...
package XReq.Environment is
   ...
   function First_Step_Dir (Env : Job_Environment) return String;
   function Step_Dir (Env : Job_Environment) return String_Vector;
   function Out_Dir (Env : Job_Environment) return String;

   procedure Fill_Missing (Env : in out Job_Environment; Feature : String);
   ...
   function Language (Env : Job_Environment) return Language_Type;
   function Loaded (Env : Job_Environment) return Boolean;
   function Steps (Env : Job_Environment) return Step_File_List_Handle;

   Null_Job_Environment : constant Job_Environment;

private

   type Job_Environment is new Reffy.Counted_Type with record
