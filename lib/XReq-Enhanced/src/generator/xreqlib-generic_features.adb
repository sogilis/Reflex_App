...
package body XReqLib.Generic_Features is
   ...
   procedure Make (F : out Feature_Type; Name : in String := "") is
   ...
   procedure Set_Name (F : in out Feature_Type; Name : in String) is
   begin
   ...
   procedure Set_Position (F : in out Feature_Type; Pos : in Position_Type) is
   begin
      F.Pos := Pos;
   end Set_Position;
   ...
   procedure Set_Background (F : in out Feature_Type; Bg : in Scenario_Type) is
   begin
      F.Background := Bg;
   end Set_Background;
   ...
   procedure Set_Description (F : in out Feature_Type; Desc : in String) is
   begin
   ...
   procedure Set_Filetype (F : in out Feature_Type; FType : in String) is
   begin
   ...
   procedure Append_Description (F : in out Feature_Type; Desc : in String) is
      use Ada.Strings;
   ...
   function Scenario_First (F : in Feature_Type) return Natural is
      pragma Unreferenced (F);
   begin
      return 0;
   end Scenario_First;
   ...
   function Scenario_Last (F : in Feature_Type) return Integer is
   begin
   ...
   function Scenario_Count (F : in Feature_Type) return Natural is
      use Scenario_Container;
   begin
   ...
   procedure Scenario_Append (F : in out Feature_Type; S : in Scenario_Type) is
      use Scenario_Container;
   begin
