...
package XReqLib.Generic_Features is
   ...
   procedure Make (F : out Feature_Type; Name : in String := "");
   ...
   procedure Set_Name (F : in out Feature_Type; Name : in String);
   procedure Set_Position (F : in out Feature_Type; Pos : in Position_Type);
   procedure Set_Background (F : in out Feature_Type; Bg : in Scenario_Type);
   procedure Set_Description (F : in out Feature_Type; Desc : in String);
   procedure Set_Filetype (F : in out Feature_Type; FType : in String);
   procedure Append_Description (F : in out Feature_Type; Desc : in String);
   procedure Set_Language (F : in out Feature_Type; Lang : in Language_Handle);
   ...
   procedure Scenario_Append (F : in out Feature_Type; S : in Scenario_Type);
...
private
   ...
   type Feature_Type is tagged record
