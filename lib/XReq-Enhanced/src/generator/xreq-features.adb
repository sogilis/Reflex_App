...
package body XReq.Features is
   ...
   procedure Make (F : out Feature_Type; Name : String := "") is
   begin
      F :=
        (Reffy.Counted_Type (F) with
   ...
   function Parsed (F : Feature_Type) return Boolean is
   ...
   function Name (F : Feature_Type) return String is
   begin
   ...
   function Position (F : Feature_Type) return Position_Type is
   begin
      return F.Pos;
   end Position;
   ...
   function Description (F : Feature_Type) return String is
   begin
   ...
   function Background (F : Feature_Type) return Scenario_Handle is
   begin
      return F.Background;
   end Background;
   ...
   function Filetype (F : Feature_Type) return String is
   begin
   ...
   function Language (F : Feature_Type) return Language_Handle is
   begin
      return F.Lang;
   end Language;
   ...
   function To_String (F : Feature_Type) return String is
   ...
   procedure Set_Name (F : in out Feature_Type; Name : String) is
   begin
   ...
   procedure Set_Position (F : in out Feature_Type; Pos : Position_Type) is
   begin
      F.Pos := Pos;
   end Set_Position;
   ...
   procedure Set_Description (F : in out Feature_Type; Desc : String) is
   begin
   ...
   procedure Set_Filetype (F : in out Feature_Type; FType : String) is
   begin
   ...
   procedure Append_Description (F : in out Feature_Type; Desc : String) is
      use Ada.Strings;
   ...
   function Scenario_First (F : Feature_Type) return Natural is
      pragma Unreferenced (F);
   begin
      return 0;
   end Scenario_First;
   ...
   function Scenario_Last (F : Feature_Type) return Integer is
   begin
   ...
   function Scenario_Count (F : Feature_Type) return Natural is
      use Scenario_Container;
   begin
