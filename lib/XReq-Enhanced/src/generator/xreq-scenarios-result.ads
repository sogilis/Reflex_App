...
package XReq.Scenarios.Result is
   ...
   function Outline_First (S : Result_Scenario_Type) return Natural;
   function Outline_Last (S : Result_Scenario_Type) return Integer;
   function Outline_Count (S : Result_Scenario_Type) return Natural;
...
private
   ...
   package Result_Steps_Vectors2 is new Ada.Containers.Vectors
     (Natural,
      Result_Steps.Vector,
      Result_Steps."=");

   type Result_Scenario_Type is new XReq.Scenarios.Scenario_Type with record
