...
package Util.Strings.Pool is
   ...
   procedure Add_Pool (Pool : in out String_Pool; Str : String);
   procedure Get_Unique_String
...
private
   ...
   package String_Pools is new Ada.Containers.Hashed_Sets
     (Unbounded_String,
      Hash,
      "=",
      "=");

   type String_Pool is record
