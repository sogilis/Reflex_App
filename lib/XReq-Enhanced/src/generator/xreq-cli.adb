...
package body XReq.CLI is
   ...
   begin
      ...
      Put_Line ("");
      Put_Line
        ("    XReq takes as input feature files describing specifications and");
      Put_Line
        ("    generate tests for these features in languages such as Ada, C, C++.");
      Put_Line ("");
      Put_Line
        ("    Specifications are described in a formalized natural language (see");
      Put_Line
        ("    cucumber documentation) and the sentences are translated in code using");
      Put_Line
        ("    using steps. These steps define a relation between the regular");
      Put_Line
        ("    expression matching the sentance and a function to perform what the");
      ...
      Put_Line
        ("        Specify a step directory.  By default, the step_definitions/");
      Put_Line
        ("        directory relative to each feature file specified is searched.");
      Put_Line ("");
      ...
      Put_Line ("        Choose which language to generate.");
      Put_Line ("        Available languages: Ada");
      Put_Line ("");
      Put_Line ("    -t, --target TARGET");
      Put_Line
        ("        Specify a target type for which to generate the test sources.");
      Put_Line ("        Available targets: X86_64 (or NATIVE), ARM_EABI");
      Put_Line ("");
      Put_Line ("    -i, --io IO");
      Put_Line
        ("        Specify a IO type to use for text ouputs.");
      Put_Line ("        Available types: STANDARD, SERIAL (only relevant for ARM_EABI target)");
      Put_Line ("");
      Put_Line ("    -m, --make");
      Put_Line
      ...
      Put_Line ("");
      Put_Line ("    --gnatcov");
      Put_Line ("        Link project with gnat coverage.");
      Put_Line ("");
      Put_Line ("    -v, --verbose");
      Put_Line ("        Increase verbose level.");
      Put_Line ("");
      ...
      Put_Line ("");
      Put_Line ("    --check-only");
      Put_Line ("        Don't generate anything. Only do a syntax check of feature file(s)");
      Put_Line ("");
      ...
      Put_Line ("");
      Put_Line
        ("    These configurations options are specified on the command line using");
      Put_Line
        ("    the switch -c with an argument of the form NAME=VALUE. If an option is");
      Put_Line
        ("    not recognized, it is silently ignored. Possible options are:");
      Put_Line ("");
