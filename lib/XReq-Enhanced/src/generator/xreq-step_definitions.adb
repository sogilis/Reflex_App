...
package body XReq.Step_Definitions is
   ...
   function Parsed (S : Step_File_Type) return Boolean is
   begin
      return S.Parsed;
   end Parsed;
   ...
   begin
      ...
      for i in S.Steps.First_Index .. S.Steps.Last_Index loop
         ...
         if Step.Prefix = Stanza.R.Kind then
            ...
            begin
               Log.Put_Line
               (2, "XReq.Steps.Ada.Find: Match """ &
                Stanza.Ref.To_String &
                """ against |" &
            ...
            Log.Put_Line
            (2, String'
               ("XReq.Steps.Ada.Find: Don't Match " &
                Stanza.R.Kind'Img &
                " """ &
                Stanza.R.Stanza &
                """ against " &
   ...
   function File_Name (S : Step_File_Type) return String is
   begin
