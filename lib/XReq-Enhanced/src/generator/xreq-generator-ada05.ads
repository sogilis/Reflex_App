...
package XReq.Generator.Ada05 is
   ...
   procedure Generate (Gen : in out Ada_Generator_Type; Log : Logger_Ptr);

   function Full_Name (Gen : Ada_Generator_Type) return String;
...
private
   ...
   type Ada_Generator_Type is new Generator_Type with record
