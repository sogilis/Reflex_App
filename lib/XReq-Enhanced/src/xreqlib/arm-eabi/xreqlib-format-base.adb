...
--        Format.Output.Buffer_Commit;
   ...
   procedure S_Feature  (F : in out Base_Format_Type; S : String) is begin F.Str_Feature  := To_Unbounded_String (S); end S_Feature;
   procedure S_Scenario (F : in out Base_Format_Type; S : String) is begin F.Str_Scenario := To_Unbounded_String (S); end S_Scenario;
   procedure S_Outline  (F : in out Base_Format_Type; S : String) is begin F.Str_Outline  := To_Unbounded_String (S); end S_Outline;
   procedure S_Examples (F : in out Base_Format_Type; S : String) is begin F.Str_Examples := To_Unbounded_String (S); end S_Examples;

   function  S_Feature  (F : Base_Format_Type) return String is begin return To_String (F.Str_Feature);  end S_Feature;
   function  S_Scenario (F : Base_Format_Type) return String is begin return To_String (F.Str_Scenario); end S_Scenario;
   function  S_Outline  (F : Base_Format_Type) return String is begin return To_String (F.Str_Outline);  end S_Outline;
   function  S_Examples (F : Base_Format_Type) return String is begin return To_String (F.Str_Examples);  end S_Examples;
