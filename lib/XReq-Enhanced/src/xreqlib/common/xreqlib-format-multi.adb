...
package body XReqLib.Format.Multi is
   ...
   begin
      while Has_Element (I) loop
         Element (I).End_Scenario (Success);
         Next (I);
      end loop;
   end End_Scenario;
   ...
   procedure Set_Output (Format : in out Multi_Format_Type; Output : String) is
      I : Cursor := First (Format.Sub_Formats);
   begin
      while Has_Element (I) loop
   ...
   procedure List_Feature (Format : in out Multi_Format_Type; Name : String) is
      I : Cursor := First (Format.Sub_Formats);
   begin
      while Has_Element (I) loop
   ...
   procedure S_Feature (F : in out Multi_Format_Type; S : String) is
   ...
   procedure S_Scenario (F : in out Multi_Format_Type; S : String) is
      I : Cursor := First (F.Sub_Formats);
   begin
      while Has_Element (I) loop
   ...
   procedure S_Outline (F : in out Multi_Format_Type; S : String) is
      I : Cursor := First (F.Sub_Formats);
   begin
      while Has_Element (I) loop
   ...
   procedure S_Examples (F : in out Multi_Format_Type; S : String) is
      I : Cursor := First (F.Sub_Formats);
   begin
      while Has_Element (I) loop
         Element (I).S_Examples (S);
         Next (I);
      end loop;
   end S_Examples;
