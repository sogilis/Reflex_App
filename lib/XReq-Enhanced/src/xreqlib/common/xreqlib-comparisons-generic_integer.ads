...
package XReqLib.Comparisons.Generic_Integer is

   function Extract_Expected_From_Match (Match : String) return Integer_Type;
   pragma Precondition
   ...
   function Extract_Greater_Than_Expected_From_Match
     (Match : String) return Integer_Type;
   ...
   pragma Postcondition (Extract_Absolute_Tolerance_From_Match'Result >= 0);

   function Extract_Relative_Tolerance_From_Match
     (Match : String) return Integer_Type;
   pragma Precondition (Get_Match_Type (Match) = Relative_Tolerance);
   pragma Postcondition
     (Extract_Relative_Tolerance_From_Match'Result >= 0
      and then Extract_Relative_Tolerance_From_Match'Result <= 100);

end XReqLib.Comparisons.Generic_Integer;
