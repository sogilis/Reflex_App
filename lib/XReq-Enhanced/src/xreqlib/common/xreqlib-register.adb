...
package body XReqLib.Register is
   ...
   procedure Call_Hook (Timing : Hook_Timing; Position : Hook_Position) is
   ...
   type Feature_List_Type is record
   ...
   begin
      ...
      while P /= null loop
         P.Proc (Format, Cond, Report, List_Mode, Count_Mode, TC_Num);
         P := P.Next;
      end loop;
      if not List_Mode and not Count_Mode then
