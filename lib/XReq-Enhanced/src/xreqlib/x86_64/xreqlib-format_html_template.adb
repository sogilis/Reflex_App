package body XReqLib.Format_HTML_Template is
   ...
   procedure page_begin (File : in out File_Type; Param_title : in String) is
   begin
      ...
      Put
        (File,
         "  /* BUG: without this, there is a spall space at the top */" &
         ASCII.LF);
      Put (File, "  -moz-border-radius-bottomright: 1em;" & ASCII.LF);
      Put (File, "  -webkit-border-radius-bottomright: 1em;" & ASCII.LF);
      Put (File, "  border-radius-bottomright: 1em;" & ASCII.LF);
      ...
      Put
        (File,
         ".report.fail, #title-background.fail, #title.fail, #progressbar.fail {" &
         ASCII.LF);
      Put (File, "  color: #fffbd3;" & ASCII.LF);
      Put (File, "  background-color: #c20000;" & ASCII.LF);
      Put (File, "}" & ASCII.LF);
      ...
      Put
        (File,
         ".report.pass, #title-background.pass, #title.pass, #progressbar.pass {" &
         ASCII.LF);
      Put (File, "  color: #dbffb4;" & ASCII.LF);
      Put (File, "  background-color: #65c400;" & ASCII.LF);
      Put (File, "}" & ASCII.LF);
      ...
      Put
        (File,
         ".report.skip, #title-background.skip, #title.skip, #progressbar.skip {" &
         ASCII.LF);
      Put (File, "  color: #004444;" & ASCII.LF);
      Put (File, "  background-color: aqua;" & ASCII.LF);
      Put (File, "}" & ASCII.LF);
      ...
      Put
        (File,
         "        document.getElementById(""link-refresh"").style.display = ""none"";" &
         ASCII.LF);
      Put (File, "      }" & ASCII.LF);
      Put (File, "      function refresh_periodic(delay) {" & ASCII.LF);
      Put
        (File,
         "        timeout_id = setTimeout(refresh, delay);" & ASCII.LF);
      Put (File, "      }" & ASCII.LF);
      Put (File, "" & ASCII.LF);
      ...
      Put
        (File,
         "          if (e.tagName && e.className.indexOf(""hidden"") == -1) {" &
         ASCII.LF);
      Put
        (File,
         "            //alert(""current: "" + e + (is_close ? ""\nclose->open"" : ""\nopen->close"") + ""\nclass: "" + e.className + ""\nnext: "" + e.nextSibling);" &
         ASCII.LF);
      Put (File, "            if (is_close) {" & ASCII.LF);
      Put
        (File,
         "              e.style.display = e.style_display;" & ASCII.LF);
      Put (File, "            } else {" & ASCII.LF);
      Put
        (File,
         "              e.style_display = e.style.display;" & ASCII.LF);
      Put (File, "              e.style.display = ""none"";" & ASCII.LF);
      Put (File, "            }" & ASCII.LF);
      Put
        (File,
         "            //alert (e + ""\ndisplay: "" + e.style.display + ""\nOld display: "" + e.style_display);" &
         ASCII.LF);
      Put (File, "          }" & ASCII.LF);
      ...
      Put
        (File,
         "        var t = document.getElementsByClassName(""debug-link"");" &
         ASCII.LF);
      Put (File, "        for(var i = 0; i < t.length; ++i) {" & ASCII.LF);
      Put
        (File,
         "          if (t[i].is_close || t[i].debug_init_processed) {" &
         ASCII.LF);
      ...
      Put
        (File,
         "            //alert(""debugInit: "" + i + "" debugLinkClicked ("" + t[i] + "")"")" &
         ASCII.LF);
      ...
      Put
        (File,
         "          var elem1 = document.getElementById(""progressbar-1"");" &
         ASCII.LF);
      ...
      Put
        (File,
         "            elem1.innerHTML = percent.toFixed(2) + ""% ("" + curr + ""/"" + total + "")"";" &
         ASCII.LF);
      Put (File, "            elem.style.display = ""block"";" & ASCII.LF);
      Put
        (File,
         "            elem.style.width = percent.toFixed(4) + ""%"";" &
         ASCII.LF);
      Put (File, "          }" & ASCII.LF);
      Put (File, "        }" & ASCII.LF);
      ...
      Put
        (File,
         "        document.getElementById(""title"").className = status;" &
         ASCII.LF);
      Put
        (File,
         "        document.getElementById(""progressbar"").className = status;" &
         ASCII.LF);
      Put
        (File,
         "        document.getElementById(""progressbar-1"").className = status;" &
         ASCII.LF);
      Put (File, "      }" & ASCII.LF);
      Put (File, "" & ASCII.LF);
      ...
      Put
        (File,
         "    <p id=""link-refresh""><a href="""" onClick=""stop_refresh(); return false"">stop refresh</a></p>" &
         ASCII.LF);
   end page_begin;
   ...
   procedure background_end (File : in out File_Type) is
   begin
      Put (File, "        </div> <!-- background-steps -->" & ASCII.LF);
      Put
        (File,
         "        <h3 class=""title-background"">Scenario:</h3>" & ASCII.LF);
   ...
   procedure outline_examples_begin (File : in out File_Type) is
   begin
      Put (File, "        <h4>Examples:</h4>" & ASCII.LF);
      Put (File, "        <div class=""outline-examples"">" & ASCII.LF);
   end outline_examples_begin;

   procedure outline_examples_end (File : in out File_Type) is
   begin
      Put (File, "        </div>" & ASCII.LF);
   ...
   begin
      Put
        (File,
         "        <script type=""text/javascript"">/*<![CDATA[*/" & ASCII.LF);
      Put
        (File,
         "          var scenario = document.getElementById(""feature-");
      Put (File, Param_feature_id);
      Put (File, "-scenario-");
      Put (File, Param_num);
      Put (File, """);" & ASCII.LF);
      Put
        (File,
         "          if (scenario.className != ""scenario fail"") {" &
         ASCII.LF);
      Put
        (File,
         "            scenario.className = ""scenario pass""" & ASCII.LF);
      Put (File, "          };" & ASCII.LF);
      Put (File, "        /*]]>*/</script>" & ASCII.LF);
   ...
   procedure scenario_tags_begin (File : in out File_Type) is
   begin
   ...
   procedure scenario_tags_end (File : in out File_Type) is
   begin
   ...
   procedure step_debug (File : in out File_Type) is
   begin
      Put
        (File,
         "          <p class=""debug-link""><a href="""" onClick=""debugLinkClicked(this.parentNode); return false;"">debug</a></p>" &
         ASCII.LF);
      Put (File, "          <hr class=""clear hidden"" />" & ASCII.LF);
   end step_debug;

   procedure step_string (File : in out File_Type; Param_string : in String) is
   begin
   ...
   procedure step_table_begin (File : in out File_Type) is
   begin
      Put (File, "          <table>" & ASCII.LF);
   end step_table_begin;

   procedure step_table_row_begin (File : in out File_Type) is
   begin
   ...
   procedure step_table_row_end (File : in out File_Type) is
   begin
      Put (File, "            </tr>" & ASCII.LF);
   end step_table_row_end;

   procedure step_table_end (File : in out File_Type) is
   begin
      Put (File, "          </table>" & ASCII.LF);
   end step_table_end;

   procedure step_separator (File : in out File_Type) is
   begin
   ...
   procedure step_debug_end (File : in out File_Type) is
   begin
      Put
        (File,
         "          <script type=""text/javascript"">/*<![CDATA[*/" &
   ...
   begin
      ...
      Put
        (File,
         "            if (feat.className != ""feature fail"") {" & ASCII.LF);
      Put
        (File,
         "              feat.className = ""feature pass"";" & ASCII.LF);
      Put (File, "            }" & ASCII.LF);
      Put (File, "          /*]]>*/</script>" & ASCII.LF);
   end step_success;
   ...
   begin
      ...
      Put
        (File,
         "          var backgrnd = document.getElementById(""feature-");
      Put (File, Param_feature_id);
      ...
      Put
        (File,
         "          if (backgrnd.className != ""scenario fail"" && scenario.className != ""scenario fail"") {" &
         ASCII.LF);
      Put
        (File,
         "            scenario.className = ""scenario pass""" & ASCII.LF);
   ...
   begin
      ...
      Put
        (File,
         "        if (feature.className != ""feature fail"") {" & ASCII.LF);
   ...
   begin
      Put
        (File,
         "    <script tyme=""text/javascript"">/*<![CDATA[*/" & ASCII.LF);
   ...
   procedure report_menu_begin (File : in out File_Type) is
   begin
   ...
   procedure report_menu_scenarios_begin (File : in out File_Type) is
   begin
      Put (File, "            <ul>" & ASCII.LF);
   ...
   procedure report_menu_scenarios_end (File : in out File_Type) is
   begin
      Put (File, "            </ul>" & ASCII.LF);
   end report_menu_scenarios_end;

   procedure report_menu_feature_end (File : in out File_Type) is
   begin
      Put (File, "          </li>" & ASCII.LF);
   end report_menu_feature_end;

   procedure report_menu_end (File : in out File_Type) is
   begin
      Put (File, "        </ul>" & ASCII.LF);
      Put (File, "      </div>" & ASCII.LF);
   end report_menu_end;

   procedure report_end (File : in out File_Type) is
   begin
      Put (File, "    </div>" & ASCII.LF);
   end report_end;

   procedure page_end (File : in out File_Type) is
   begin
      Put (File, "  </body>" & ASCII.LF);
      Put
        (File,
