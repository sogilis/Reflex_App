...
--        Format.Output.Buffer_Commit;
   ...
   begin
      ...
      Format.Outline            :=
        (Name     => To_Unbounded_String (Scenario),
         Position => To_Unbounded_String (Position),
         Tags     => Convert (Tags),
         others   => <>);
   end Start_Outline;
   ...
   begin
      ...
      Format.Background         :=
        (Name     => To_Unbounded_String (Background),
         Position => To_Unbounded_String (Position),
         others   => <>);
   ...
   procedure Set_Output (Format : in out Base_Format_Type; Output : String) is
   begin
      XReqLib.Standard_IO.T_Standard_IO (Format.Output.all).Create
      (Ada.Text_IO.Out_File, Output);
   end Set_Output;
   ...
   procedure List_Feature (Format : in out Base_Format_Type; Name : String) is
   begin
   ...
   procedure S_Feature (F : in out Base_Format_Type; S : String) is
   begin
      F.Str_Feature := To_Unbounded_String (S);
   end S_Feature;
   procedure S_Scenario (F : in out Base_Format_Type; S : String) is
   begin
      F.Str_Scenario := To_Unbounded_String (S);
   end S_Scenario;
   procedure S_Outline (F : in out Base_Format_Type; S : String) is
   begin
      F.Str_Outline := To_Unbounded_String (S);
   end S_Outline;
   procedure S_Examples (F : in out Base_Format_Type; S : String) is
   begin
      F.Str_Examples := To_Unbounded_String (S);
   end S_Examples;

   function S_Feature (F : Base_Format_Type) return String is
   begin
      return To_String (F.Str_Feature);
   end S_Feature;
   function S_Scenario (F : Base_Format_Type) return String is
   begin
      return To_String (F.Str_Scenario);
   end S_Scenario;
   function S_Outline (F : Base_Format_Type) return String is
   begin
      return To_String (F.Str_Outline);
   end S_Outline;
   function S_Examples (F : Base_Format_Type) return String is
   begin
      return To_String (F.Str_Examples);
   end S_Examples;
