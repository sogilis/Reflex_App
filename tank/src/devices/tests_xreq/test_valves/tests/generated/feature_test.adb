...
package body feature_test is
   ...
   begin
      ...
      if Count_Mode then
         ...
         declare
            ...
            Stanza : constant String    := "valve component is initialized";
            Pos    : constant String    := "./features/test.feature:4";
         begin
            Make (Args, "valve component is initialized");
            Add_Sep   (Args, 1);
            ...
            if Fail then
               ...
               Given_valve_component_is_initialized (Args);
   ...
   begin
      if Count_Mode then
         ...
         declare
            ...
            Stanza : constant String    := "Open is FALSE ";
            Pos    : constant String    := "./features/test.feature:10";
         begin
            Make (Args, "Open is FALSE ");
            Add_Match (Args, 9, 13);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
         ...
         Format.Stop_Step;
         --
         -- Then Open_Order is FALSE 
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Then;
            Stanza : constant String    := "Open_Order is FALSE ";
            Pos    : constant String    := "./features/test.feature:16";
         begin
            Make (Args, "Open_Order is FALSE ");
   ...
   begin
      if Count_Mode then
         ...
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Open is TRUE ";
            Pos    : constant String    := "./features/test.feature:10";
         begin
            Make (Args, "Open is TRUE ");
            Add_Match (Args, 9, 12);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
   ...
   begin
      if Count_Mode then
         ...
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Close is TRUE ";
            Pos    : constant String    := "./features/test.feature:11";
         begin
            Make (Args, "Close is TRUE ");
            Add_Match (Args, 10, 13);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
            if Fail then
         ...
         Format.Stop_Step;
         --
         -- Then New_State is Closing_State 
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Then;
            Stanza : constant String    := "New_State is Closing_State ";
            Pos    : constant String    := "./features/test.feature:15";
         begin
            Make (Args, "New_State is Closing_State ");
            Add_Match (Args, 14, 26);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
         ...
         Format.Stop_Step;
         --
         -- Then Close_Order is TRUE 
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Then;
            Stanza : constant String    := "Close_Order is TRUE ";
            Pos    : constant String    := "./features/test.feature:17";
         begin
            Make (Args, "Close_Order is TRUE ");
   ...
   begin
      if Count_Mode then
         ...
         Format.Begin_Scenario;
         --
         -- Given State is Opening_State
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Given;
            Stanza : constant String    := "State is Opening_State";
            Pos    : constant String    := "./features/test.feature:8";
         begin
            Make (Args, "State is Opening_State");
            Add_Match (Args, 10, 22);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
         ...
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Opened is TRUE ";
            Pos    : constant String    := "./features/test.feature:12";
         begin
            Make (Args, "Opened is TRUE ");
         ...
         Format.Stop_Step;
         --
         -- Then New_State is Opened_State 
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Then;
            Stanza : constant String    := "New_State is Opened_State ";
            Pos    : constant String    := "./features/test.feature:15";
         begin
            Make (Args, "New_State is Opened_State ");
   ...
   begin
      if Count_Mode then
         ...
         Format.Begin_Scenario;
         --
         -- Given State is Opened_State
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Given;
            Stanza : constant String    := "State is Opened_State";
            Pos    : constant String    := "./features/test.feature:8";
         begin
            Make (Args, "State is Opened_State");
   ...
   begin
      if Count_Mode then
         ...
         Format.Begin_Scenario;
         --
         -- Given State is Closing_State
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Given;
            Stanza : constant String    := "State is Closing_State";
            Pos    : constant String    := "./features/test.feature:8";
         begin
            Make (Args, "State is Closing_State");
            Add_Match (Args, 10, 22);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
         ...
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Closed is TRUE";
            Pos    : constant String    := "./features/test.feature:13";
         begin
            Make (Args, "Closed is TRUE");
            Add_Match (Args, 11, 14);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
         ...
         Format.Stop_Step;
         --
         -- Then New_State is Closed_State 
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Then;
            Stanza : constant String    := "New_State is Closed_State ";
            Pos    : constant String    := "./features/test.feature:15";
         begin
            Make (Args, "New_State is Closed_State ");
            Add_Match (Args, 14, 25);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
   ...
   begin
      if Count_Mode then
         ...
         Format.Begin_Scenario;
         --
         -- Given State is Closed_State
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_Given;
            Stanza : constant String    := "State is Closed_State";
            Pos    : constant String    := "./features/test.feature:8";
         begin
            Make (Args, "State is Closed_State");
            Add_Match (Args, 10, 21);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
   ...
   begin
      ...
      if List_Mode then
         Format.List_Feature ("Valves tests");
         ...
         Format.Start_Feature ("Valves tests", "", "./features/test.feature:1");
