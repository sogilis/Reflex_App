...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_valves_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#7f1e98c2#;
   pragma Export (C, u00001, "valves_testsB");
   ...
   u00135 : constant Version_32 := 16#6fc0cd94#;
   ...
   u00164 : constant Version_32 := 16#e7591632#;
   pragma Export (C, u00164, "step_definitionsB");
   u00165 : constant Version_32 := 16#7c853250#;
