...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_resistances_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#6059ded6#;
   pragma Export (C, u00001, "resistances_testsB");
   ...
   u00135 : constant Version_32 := 16#2254709c#;
   ...
   u00164 : constant Version_32 := 16#c8dda20e#;
   pragma Export (C, u00164, "step_definitionsB");
   u00165 : constant Version_32 := 16#742c5eaf#;
   ...
   u00168 : constant Version_32 := 16#8e59781f#;
   pragma Export (C, u00168, "devices__resistancesB");
   u00169 : constant Version_32 := 16#9e820bfa#;
   pragma Export (C, u00169, "devices__resistancesS");
   ...
   u00185 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00185, "system__val_realB");
   u00186 : constant Version_32 := 16#484a00d1#;
   pragma Export (C, u00186, "system__val_realS");
   u00187 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00187, "system__exn_llfB");
   u00188 : constant Version_32 := 16#fa4b57d8#;
   pragma Export (C, u00188, "system__exn_llfS");
   u00189 : constant Version_32 := 16#42a257f7#;
   ...
   u00191 : constant Version_32 := 16#a6c9af38#;
   pragma Export (C, u00191, "system__float_controlS");
   u00192 : constant Version_32 := 16#16458a73#;
   pragma Export (C, u00192, "system__powten_tableS");
   u00193 : constant Version_32 := 16#88a20b05#;
   pragma Export (C, u00193, "xreqlibS");
   u00194 : constant Version_32 := 16#366d6406#;
   pragma Export (C, u00194, "xreqlib__assertsB");
   u00195 : constant Version_32 := 16#0740edbd#;
   pragma Export (C, u00195, "xreqlib__assertsS");
   u00196 : constant Version_32 := 16#46b1f5ea#;
   pragma Export (C, u00196, "system__concat_8B");
   u00197 : constant Version_32 := 16#a532a1d3#;
   ...
   u00202 : constant Version_32 := 16#352f7eb1#;
   pragma Export (C, u00202, "xreqlib__argsB");
   u00203 : constant Version_32 := 16#52c2e1eb#;
   pragma Export (C, u00203, "xreqlib__argsS");
   u00204 : constant Version_32 := 16#a56e241a#;
   pragma Export (C, u00204, "xreqlib__variablesB");
   u00205 : constant Version_32 := 16#d32fa600#;
   pragma Export (C, u00205, "xreqlib__variablesS");
   u00206 : constant Version_32 := 16#c164a034#;
   pragma Export (C, u00206, "ada__containers__hash_tablesS");
   u00207 : constant Version_32 := 16#bcec81df#;
   pragma Export (C, u00207, "ada__containers__helpersB");
   u00208 : constant Version_32 := 16#4adfc5eb#;
   pragma Export (C, u00208, "ada__containers__helpersS");
   ...
   u00217 : constant Version_32 := 16#dcdc2328#;
   pragma Export (C, u00217, "xreqlib__string_hashB");
   u00218 : constant Version_32 := 16#47780136#;
   pragma Export (C, u00218, "xreqlib__string_hashS");
   u00219 : constant Version_32 := 16#a66a18ed#;
   pragma Export (C, u00219, "xreqlib__containersS");
   u00220 : constant Version_32 := 16#012b84c7#;
   pragma Export (C, u00220, "xreqlib__string_tablesB");
   u00221 : constant Version_32 := 16#6cb3448d#;
   pragma Export (C, u00221, "xreqlib__string_tablesS");
   u00222 : constant Version_32 := 16#0f9783a4#;
   pragma Export (C, u00222, "system__val_intB");
   u00223 : constant Version_32 := 16#f3ca8567#;
   pragma Export (C, u00223, "system__val_intS");
   u00224 : constant Version_32 := 16#383fd226#;
   pragma Export (C, u00224, "system__val_unsB");
   u00225 : constant Version_32 := 16#47b5ed3e#;
   pragma Export (C, u00225, "system__val_unsS");
   u00226 : constant Version_32 := 16#91144734#;
   pragma Export (C, u00226, "xreqlib__tablesB");
   u00227 : constant Version_32 := 16#d515eef1#;
   pragma Export (C, u00227, "xreqlib__tablesS");
   u00228 : constant Version_32 := 16#8225628b#;
   pragma Export (C, u00228, "ada__containers__red_black_treesS");
   u00229 : constant Version_32 := 16#78cb869e#;
   pragma Export (C, u00229, "system__concat_9B");
   u00230 : constant Version_32 := 16#9a7fd820#;
   pragma Export (C, u00230, "system__concat_9S");
   u00231 : constant Version_32 := 16#48862aff#;
   pragma Export (C, u00231, "xreqlib__registerB");
   u00232 : constant Version_32 := 16#3dd88383#;
   pragma Export (C, u00232, "xreqlib__registerS");
   u00233 : constant Version_32 := 16#c305dc62#;
   pragma Export (C, u00233, "xreqlib__formatB");
   u00234 : constant Version_32 := 16#93b0ecdf#;
   pragma Export (C, u00234, "xreqlib__formatS");
   u00235 : constant Version_32 := 16#bf363ed2#;
   pragma Export (C, u00235, "ada__strings__fixedB");
   u00236 : constant Version_32 := 16#fec1aafc#;
   pragma Export (C, u00236, "ada__strings__fixedS");
   u00237 : constant Version_32 := 16#a36d4ac3#;
   pragma Export (C, u00237, "xreqlib__reportB");
   u00238 : constant Version_32 := 16#3c5fd0f4#;
   pragma Export (C, u00238, "xreqlib__reportS");
   u00239 : constant Version_32 := 16#64355e67#;
   pragma Export (C, u00239, "xreqlib__cliB");
   u00240 : constant Version_32 := 16#937386c8#;
   pragma Export (C, u00240, "xreqlib__cliS");
   u00241 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00241, "gnatS");
   u00242 : constant Version_32 := 16#08e6068b#;
   pragma Export (C, u00242, "gnat__command_lineB");
   u00243 : constant Version_32 := 16#d602660e#;
   pragma Export (C, u00243, "gnat__command_lineS");
   u00244 : constant Version_32 := 16#9321d98c#;
   pragma Export (C, u00244, "gnat__directory_operationsB");
   u00245 : constant Version_32 := 16#8f1a5551#;
   pragma Export (C, u00245, "gnat__directory_operationsS");
   u00246 : constant Version_32 := 16#ef2c0748#;
   pragma Export (C, u00246, "gnat__os_libS");
   u00247 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00247, "gnat__regexpS");
   u00248 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00248, "system__regexpB");
   u00249 : constant Version_32 := 16#65074bc8#;
   pragma Export (C, u00249, "system__regexpS");
   u00250 : constant Version_32 := 16#fcd606d0#;
   pragma Export (C, u00250, "gnat__stringsS");
   u00251 : constant Version_32 := 16#1340ad7c#;
   pragma Export (C, u00251, "xreqlib__ansiB");
   u00252 : constant Version_32 := 16#6258ce33#;
   pragma Export (C, u00252, "xreqlib__ansiS");
   u00253 : constant Version_32 := 16#47a94a8f#;
   pragma Export (C, u00253, "xreqlib__error_handlingB");
   u00254 : constant Version_32 := 16#3e198be2#;
   pragma Export (C, u00254, "xreqlib__error_handlingS");
   u00255 : constant Version_32 := 16#d68961e2#;
   pragma Export (C, u00255, "xreqlib__format__htmlB");
   u00256 : constant Version_32 := 16#96fb4933#;
   pragma Export (C, u00256, "xreqlib__format__htmlS");
   u00257 : constant Version_32 := 16#10a32ed5#;
   pragma Export (C, u00257, "xreqlib__format_html_templateB");
   u00258 : constant Version_32 := 16#c1e76384#;
   pragma Export (C, u00258, "xreqlib__format_html_templateS");
   u00259 : constant Version_32 := 16#55a13880#;
   pragma Export (C, u00259, "xreqlib__standard_ioB");
   u00260 : constant Version_32 := 16#1abf910c#;
   pragma Export (C, u00260, "xreqlib__standard_ioS");
   u00261 : constant Version_32 := 16#f670262a#;
   pragma Export (C, u00261, "xreqlib__ioS");
   u00262 : constant Version_32 := 16#835d255c#;
   pragma Export (C, u00262, "xreqlib__format__baseB");
   u00263 : constant Version_32 := 16#4042906c#;
   pragma Export (C, u00263, "xreqlib__format__baseS");
   u00264 : constant Version_32 := 16#e54d53d3#;
   pragma Export (C, u00264, "xreqlib__format__multiB");
   u00265 : constant Version_32 := 16#0d38c0a1#;
   pragma Export (C, u00265, "xreqlib__format__multiS");
   u00266 : constant Version_32 := 16#224714e5#;
   pragma Export (C, u00266, "xreqlib__format__textB");
   u00267 : constant Version_32 := 16#78aadcc5#;
   pragma Export (C, u00267, "xreqlib__format__textS");
   u00268 : constant Version_32 := 16#4b8413c6#;
   pragma Export (C, u00268, "xreqlib__utilB");
   u00269 : constant Version_32 := 16#b86b53fa#;
   pragma Export (C, u00269, "xreqlib__utilS");
