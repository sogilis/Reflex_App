--  File: ./generated/resistances_tests.adb
with feature_test;
pragma Unreferenced (feature_test);
...
procedure resistances_tests is
   Self_Name : constant String := "resistances_tests";
