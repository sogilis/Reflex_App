...
package body feature_test is
   ...
   begin
      ...
      if Count_Mode then
         ...
         declare
            ...
            Stanza : constant String    := "resistance component is initialized";
            Pos    : constant String    := "./features/test.feature:4";
         begin
            Make (Args, "resistance component is initialized");
            Add_Sep   (Args, 1);
            ...
            if Fail then
               ...
               Given_resistance_component_is_initialized (Args);
   ...
   begin
      if Count_Mode then
         ...
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "T_Regul is 100 ";
            Pos    : constant String    := "./features/test.feature:10";
         begin
            Make (Args, "T_Regul is 100 ");
            Add_Match (Args, 12, 14);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
            if Fail then
         ...
         Format.Stop_Step;
         --
         -- When Set_Point is 100
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Set_Point is 100";
            Pos    : constant String    := "./features/test.feature:11";
         begin
            Make (Args, "Set_Point is 100");
            Add_Match (Args, 14, 16);
            Add_Sep   (Args, 1);
            Format.Start_Step (Prefix, Stanza, Pos);
            Format.Begin_Step;
            if Fail then
   ...
   begin
      if Count_Mode then
         ...
         Format.Stop_Step;
         --
         -- When Set_Point is 50
         --
         declare
            Args   : Arg_Type;
            Prefix : constant Step_Kind := Step_When;
            Stanza : constant String    := "Set_Point is 50";
            Pos    : constant String    := "./features/test.feature:11";
         begin
            Make (Args, "Set_Point is 50");
   ...
   begin
      ...
      if List_Mode then
         Format.List_Feature ("Resistances tests");
         ...
         Format.Start_Feature ("Resistances tests", "", "./features/test.feature:1");
