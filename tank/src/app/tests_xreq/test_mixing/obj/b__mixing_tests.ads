...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_mixing_tests" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#8b14ecd5#;
   pragma Export (C, u00001, "mixing_testsB");
   ...
   u00135 : constant Version_32 := 16#1fc62beb#;
   pragma Export (C, u00135, "feature_testB");
   u00136 : constant Version_32 := 16#f381b574#;
   ...
   u00164 : constant Version_32 := 16#24272ce8#;
   pragma Export (C, u00164, "step_definitionsB");
   u00165 : constant Version_32 := 16#8223a9b2#;
   ...
   u00175 : constant Version_32 := 16#e037a928#;
   pragma Export (C, u00175, "tank__mixingB");
   u00176 : constant Version_32 := 16#3baa2910#;
   pragma Export (C, u00176, "tank__mixingS");
   ...
   u00230 : constant Version_32 := 16#64355e67#;
   pragma Export (C, u00230, "xreqlib__cliB");
   u00231 : constant Version_32 := 16#937386c8#;
   pragma Export (C, u00231, "xreqlib__cliS");
   u00232 : constant Version_32 := 16#b5988c27#;
   pragma Export (C, u00232, "gnatS");
   u00233 : constant Version_32 := 16#08e6068b#;
   pragma Export (C, u00233, "gnat__command_lineB");
   u00234 : constant Version_32 := 16#d602660e#;
   pragma Export (C, u00234, "gnat__command_lineS");
   u00235 : constant Version_32 := 16#9321d98c#;
   pragma Export (C, u00235, "gnat__directory_operationsB");
   u00236 : constant Version_32 := 16#8f1a5551#;
   pragma Export (C, u00236, "gnat__directory_operationsS");
   u00237 : constant Version_32 := 16#ef2c0748#;
   pragma Export (C, u00237, "gnat__os_libS");
   u00238 : constant Version_32 := 16#40fe4806#;
   pragma Export (C, u00238, "gnat__regexpS");
   u00239 : constant Version_32 := 16#95f86c43#;
   pragma Export (C, u00239, "system__regexpB");
   u00240 : constant Version_32 := 16#65074bc8#;
   pragma Export (C, u00240, "system__regexpS");
   u00241 : constant Version_32 := 16#fcd606d0#;
   pragma Export (C, u00241, "gnat__stringsS");
   u00242 : constant Version_32 := 16#1340ad7c#;
   pragma Export (C, u00242, "xreqlib__ansiB");
   u00243 : constant Version_32 := 16#6258ce33#;
   pragma Export (C, u00243, "xreqlib__ansiS");
   u00244 : constant Version_32 := 16#47a94a8f#;
   pragma Export (C, u00244, "xreqlib__error_handlingB");
   u00245 : constant Version_32 := 16#3e198be2#;
   pragma Export (C, u00245, "xreqlib__error_handlingS");
   u00246 : constant Version_32 := 16#d68961e2#;
   pragma Export (C, u00246, "xreqlib__format__htmlB");
   u00247 : constant Version_32 := 16#96fb4933#;
   pragma Export (C, u00247, "xreqlib__format__htmlS");
   u00248 : constant Version_32 := 16#10a32ed5#;
   pragma Export (C, u00248, "xreqlib__format_html_templateB");
   u00249 : constant Version_32 := 16#c1e76384#;
   pragma Export (C, u00249, "xreqlib__format_html_templateS");
   u00250 : constant Version_32 := 16#55a13880#;
   pragma Export (C, u00250, "xreqlib__standard_ioB");
   u00251 : constant Version_32 := 16#1abf910c#;
   pragma Export (C, u00251, "xreqlib__standard_ioS");
   u00252 : constant Version_32 := 16#f670262a#;
   pragma Export (C, u00252, "xreqlib__ioS");
   u00253 : constant Version_32 := 16#835d255c#;
   pragma Export (C, u00253, "xreqlib__format__baseB");
   u00254 : constant Version_32 := 16#4042906c#;
   pragma Export (C, u00254, "xreqlib__format__baseS");
   u00255 : constant Version_32 := 16#e54d53d3#;
   pragma Export (C, u00255, "xreqlib__format__multiB");
   u00256 : constant Version_32 := 16#0d38c0a1#;
   pragma Export (C, u00256, "xreqlib__format__multiS");
   u00257 : constant Version_32 := 16#224714e5#;
   pragma Export (C, u00257, "xreqlib__format__textB");
   u00258 : constant Version_32 := 16#78aadcc5#;
   pragma Export (C, u00258, "xreqlib__format__textS");
   u00259 : constant Version_32 := 16#4b8413c6#;
   pragma Export (C, u00259, "xreqlib__utilB");
   u00260 : constant Version_32 := 16#b86b53fa#;
   pragma Export (C, u00260, "xreqlib__utilS");
