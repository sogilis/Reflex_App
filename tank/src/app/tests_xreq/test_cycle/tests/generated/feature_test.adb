...
package body feature_test is
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (1/8)", "./features/test.feature:6", Tags);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (2/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (3/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (4/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (5/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (6/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (7/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (8/8)", "./features/test.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
