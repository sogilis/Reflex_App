...
package body feature_test001 is
   ...
   begin
      if Count_Mode then
         ...
         Report.Num_Steps := Report.Num_Steps + 11;
      else
         Format.Start_Scenario ("state (1/7)", "./features/test001.feature:6", Tags);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (2/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (3/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (4/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (5/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (6/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      if Count_Mode then
         ...
         Format.Start_Scenario ("state (7/7)", "./features/test001.feature:6", Tags);
         Format.Enter_Scenario;
         Call_Hook (Hook_Begin, Hook_Scenario);
   ...
   begin
      ...
      if List_Mode then
         Format.List_Feature ("Filling_1 tests");
         ...
         Format.Start_Feature ("Filling_1 tests", "", "./features/test001.feature:1");
