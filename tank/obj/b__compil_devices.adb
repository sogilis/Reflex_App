pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__compil_devices.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__compil_devices.adb");
...
package body ada_main is
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "devices__valves__finalize_spec");
      begin
         F1;
      end;
      E133 := E133 - 1;
      declare
         procedure F2;
         pragma Import (Ada, F2, "devices__resistances__finalize_spec");
      begin
         F2;
      end;
      E121 := E121 - 1;
      declare
         procedure F3;
         pragma Import (Ada, F3, "devices__pumps__finalize_spec");
      begin
         F3;
      end;
      E109 := E109 - 1;
      declare
         procedure F4;
         pragma Import (Ada, F4, "devices__blenders__finalize_spec");
      begin
         F4;
      end;
      E005 := E005 - 1;
      declare
         procedure F5;
         pragma Import (Ada, F5, "devices__finalize_spec");
      begin
         F5;
      end;
      E129 := E129 - 1;
   ...
   pragma Import (Ada, Ada_Main_Program, "_ada_compil_devices");
...
--  BEGIN Object file/option list
   ...
   --   /home/sogilis/sb/reflex_software/tank/obj/compil_devices.o
