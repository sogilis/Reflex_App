...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_run_tank" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#394ec758#;
   pragma Export (C, u00001, "run_tankB");
   ...
   u00120 : constant Version_32 := 16#8f774dfa#;
   pragma Export (C, u00120, "rxclockB");
   u00121 : constant Version_32 := 16#c8008bbb#;
   pragma Export (C, u00121, "rxclockS");
   ...
   u00130 : constant Version_32 := 16#d54e66a4#;
   pragma Export (C, u00130, "tankS");
   u00131 : constant Version_32 := 16#faa94c4c#;
   pragma Export (C, u00131, "tank__mainB");
   u00132 : constant Version_32 := 16#4fa2532a#;
   pragma Export (C, u00132, "tank__mainS");
   u00133 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00133, "ada__float_text_ioB");
   u00134 : constant Version_32 := 16#39060f6c#;
   pragma Export (C, u00134, "ada__float_text_ioS");
   u00135 : constant Version_32 := 16#25afee5b#;
   pragma Export (C, u00135, "ada__text_io__float_auxB");
   u00136 : constant Version_32 := 16#6ecdea4c#;
   pragma Export (C, u00136, "ada__text_io__float_auxS");
   u00137 : constant Version_32 := 16#181dc502#;
   pragma Export (C, u00137, "ada__text_io__generic_auxB");
   u00138 : constant Version_32 := 16#305a076a#;
   ...
   u00147 : constant Version_32 := 16#c5134340#;
   pragma Export (C, u00147, "system__val_realB");
   u00148 : constant Version_32 := 16#484a00d1#;
   pragma Export (C, u00148, "system__val_realS");
   u00149 : constant Version_32 := 16#b2a569d2#;
   pragma Export (C, u00149, "system__exn_llfB");
   u00150 : constant Version_32 := 16#fa4b57d8#;
   pragma Export (C, u00150, "system__exn_llfS");
   u00151 : constant Version_32 := 16#1e40f010#;
   ...
   u00154 : constant Version_32 := 16#fdedfd10#;
   pragma Export (C, u00154, "ada__text_io__integer_auxB");
   u00155 : constant Version_32 := 16#2fe01d89#;
   pragma Export (C, u00155, "ada__text_io__integer_auxS");
   u00156 : constant Version_32 := 16#b10ba0c7#;
   pragma Export (C, u00156, "system__img_biuB");
   u00157 : constant Version_32 := 16#b49118ca#;
   pragma Export (C, u00157, "system__img_biuS");
   u00158 : constant Version_32 := 16#4e06ab0c#;
   pragma Export (C, u00158, "system__img_llbB");
   u00159 : constant Version_32 := 16#f5560834#;
   ...
   u00168 : constant Version_32 := 16#1bbc1346#;
   pragma Export (C, u00168, "devicesB");
   u00169 : constant Version_32 := 16#fb10b7fe#;
   pragma Export (C, u00169, "devicesS");
   ...
   u00172 : constant Version_32 := 16#be272c5e#;
   pragma Export (C, u00172, "devices__blendersB");
   u00173 : constant Version_32 := 16#78a5d4b3#;
   pragma Export (C, u00173, "devices__blendersS");
   u00174 : constant Version_32 := 16#7b1a92d0#;
   pragma Export (C, u00174, "devices__pumpsB");
   u00175 : constant Version_32 := 16#4f782de2#;
   pragma Export (C, u00175, "devices__pumpsS");
   u00176 : constant Version_32 := 16#d96e3c40#;
   ...
   u00186 : constant Version_32 := 16#7887848a#;
   pragma Export (C, u00186, "devices__resistancesB");
   u00187 : constant Version_32 := 16#f428a47e#;
   pragma Export (C, u00187, "devices__resistancesS");
   u00188 : constant Version_32 := 16#6a2e3279#;
   pragma Export (C, u00188, "rxS");
   u00189 : constant Version_32 := 16#cb0fb547#;
   pragma Export (C, u00189, "rx__libraryS");
   u00190 : constant Version_32 := 16#aa9da292#;
   pragma Export (C, u00190, "rx__library__analogsB");
   u00191 : constant Version_32 := 16#b36520f6#;
   pragma Export (C, u00191, "rx__library__analogsS");
   u00192 : constant Version_32 := 16#f16eaaf3#;
   pragma Export (C, u00192, "rx__library__analogs__pidB");
   u00193 : constant Version_32 := 16#dbfe6fca#;
   pragma Export (C, u00193, "rx__library__analogs__pidS");
   u00194 : constant Version_32 := 16#ed267c5d#;
   pragma Export (C, u00194, "devices__valvesB");
   u00195 : constant Version_32 := 16#7effa310#;
   pragma Export (C, u00195, "devices__valvesS");
   u00196 : constant Version_32 := 16#ce949d71#;
   pragma Export (C, u00196, "iosB");
   u00197 : constant Version_32 := 16#545d1be0#;
   pragma Export (C, u00197, "iosS");
   u00198 : constant Version_32 := 16#3c293ae6#;
   pragma Export (C, u00198, "ext_iosS");
   u00199 : constant Version_32 := 16#e0e0ca3a#;
   pragma Export (C, u00199, "regulS");
   u00200 : constant Version_32 := 16#111351e0#;
   pragma Export (C, u00200, "regul__rampsB");
   u00201 : constant Version_32 := 16#db90afd7#;
   pragma Export (C, u00201, "regul__rampsS");
   u00202 : constant Version_32 := 16#1330db11#;
   pragma Export (C, u00202, "tank__cycleB");
   u00203 : constant Version_32 := 16#d07e96f5#;
   pragma Export (C, u00203, "tank__cycleS");
   u00204 : constant Version_32 := 16#eaa04eeb#;
   pragma Export (C, u00204, "tank__fillingB");
   u00205 : constant Version_32 := 16#f84e4e6c#;
   pragma Export (C, u00205, "tank__fillingS");
   u00206 : constant Version_32 := 16#e037a928#;
   pragma Export (C, u00206, "tank__mixingB");
   u00207 : constant Version_32 := 16#3baa2910#;
   pragma Export (C, u00207, "tank__mixingS");
   u00208 : constant Version_32 := 16#3a908431#;
   pragma Export (C, u00208, "tank__variablesS");
   ...
   --  rx%s
   --  rx.library%s
   --  rx.library.analogs%s
   --  rx.library.analogs%b
   --  rx.library.analogs.pid%s
   --  rx.library.analogs.pid%b
   --  rxclock%s
   --  rxclock%b
