...
package ada_main is
   ...
   u00114 : constant Version_32 := 16#ed039290#;
   ...
   u00122 : constant Version_32 := 16#ce949d71#;
   pragma Export (C, u00122, "iosB");
   u00123 : constant Version_32 := 16#545d1be0#;
   pragma Export (C, u00123, "iosS");
   u00124 : constant Version_32 := 16#3c293ae6#;
   pragma Export (C, u00124, "ext_iosS");
   u00125 : constant Version_32 := 16#d1a23dc3#;
   pragma Export (C, u00125, "ios_simulB");
   u00126 : constant Version_32 := 16#b023e221#;
   ...
   u00132 : constant Version_32 := 16#f2ec9308#;
   pragma Export (C, u00132, "simul_tank__mainB");
   u00133 : constant Version_32 := 16#97653852#;
   ...
   u00139 : constant Version_32 := 16#ebaef4ca#;
   pragma Export (C, u00139, "simul__devices__blendersB");
   u00140 : constant Version_32 := 16#b51f9834#;
   ...
   u00143 : constant Version_32 := 16#9333f90d#;
   pragma Export (C, u00143, "simul__devices__valvesB");
   u00144 : constant Version_32 := 16#9c07f18a#;
   ...
   u00150 : constant Version_32 := 16#faa94c4c#;
   ...
   u00191 : constant Version_32 := 16#be272c5e#;
   pragma Export (C, u00191, "devices__blendersB");
   u00192 : constant Version_32 := 16#78a5d4b3#;
   pragma Export (C, u00192, "devices__blendersS");
   u00193 : constant Version_32 := 16#7b1a92d0#;
   ...
   u00203 : constant Version_32 := 16#7887848a#;
   pragma Export (C, u00203, "devices__resistancesB");
   u00204 : constant Version_32 := 16#f428a47e#;
   pragma Export (C, u00204, "devices__resistancesS");
   u00205 : constant Version_32 := 16#8f774dfa#;
   pragma Export (C, u00205, "rxclockB");
   u00206 : constant Version_32 := 16#c8008bbb#;
   pragma Export (C, u00206, "rxclockS");
   u00207 : constant Version_32 := 16#6a2e3279#;
   pragma Export (C, u00207, "rxS");
   u00208 : constant Version_32 := 16#cb0fb547#;
   pragma Export (C, u00208, "rx__libraryS");
   u00209 : constant Version_32 := 16#aa9da292#;
   pragma Export (C, u00209, "rx__library__analogsB");
   u00210 : constant Version_32 := 16#b36520f6#;
   pragma Export (C, u00210, "rx__library__analogsS");
   u00211 : constant Version_32 := 16#f16eaaf3#;
   pragma Export (C, u00211, "rx__library__analogs__pidB");
   u00212 : constant Version_32 := 16#dbfe6fca#;
   pragma Export (C, u00212, "rx__library__analogs__pidS");
   u00213 : constant Version_32 := 16#ed267c5d#;
   pragma Export (C, u00213, "devices__valvesB");
   u00214 : constant Version_32 := 16#7effa310#;
   pragma Export (C, u00214, "devices__valvesS");
   u00215 : constant Version_32 := 16#e0e0ca3a#;
   pragma Export (C, u00215, "regulS");
   u00216 : constant Version_32 := 16#111351e0#;
   pragma Export (C, u00216, "regul__rampsB");
   u00217 : constant Version_32 := 16#db90afd7#;
   pragma Export (C, u00217, "regul__rampsS");
   u00218 : constant Version_32 := 16#1330db11#;
   pragma Export (C, u00218, "tank__cycleB");
   u00219 : constant Version_32 := 16#d07e96f5#;
   pragma Export (C, u00219, "tank__cycleS");
   u00220 : constant Version_32 := 16#eaa04eeb#;
   pragma Export (C, u00220, "tank__fillingB");
   u00221 : constant Version_32 := 16#f84e4e6c#;
   pragma Export (C, u00221, "tank__fillingS");
   u00222 : constant Version_32 := 16#e037a928#;
   pragma Export (C, u00222, "tank__mixingB");
   u00223 : constant Version_32 := 16#3baa2910#;
   pragma Export (C, u00223, "tank__mixingS");
   u00224 : constant Version_32 := 16#3a908431#;
   pragma Export (C, u00224, "tank__variablesS");
